...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t pp_default_3_3 "bash jobs/job_20241005_pp_default_3_3.sh" C-m
  echo "Launched jobs/job_20241005_pp_default_3_3.sh on tmux session pp_default_3_3"
