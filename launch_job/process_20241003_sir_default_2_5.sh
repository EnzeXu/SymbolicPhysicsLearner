...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t sir_default_2_5 "bash jobs/job_20241003_sir_default_2_5.sh" C-m
  echo "Launched jobs/job_20241003_sir_default_2_5.sh on tmux session sir_default_2_5"
