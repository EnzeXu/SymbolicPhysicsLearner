...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t lorenz_default_1_1 "bash jobs/job_20241004_lorenz_default_1_1.sh" C-m
  echo "Launched jobs/job_20241004_lorenz_default_1_1.sh on tmux session lorenz_default_1_1"
