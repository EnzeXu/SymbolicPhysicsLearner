...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t friction_pendulum_default_0_5 "bash jobs/job_20241002_friction_pendulum_default_0_5.sh" C-m
  echo "Launched jobs/job_20241002_friction_pendulum_default_0_5.sh on tmux session friction_pendulum_default_0_5"
