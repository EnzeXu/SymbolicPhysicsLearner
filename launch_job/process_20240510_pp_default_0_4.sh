...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t pp_default_0_4 "bash jobs/job_20240510_pp_default_0_4.sh" C-m
  echo "Launched jobs/job_20240510_pp_default_0_4.sh on tmux session pp_default_0_4"
