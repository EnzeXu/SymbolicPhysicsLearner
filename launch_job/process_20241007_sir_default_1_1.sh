...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t sir_default_1_1 "bash jobs/job_20241007_sir_default_1_1.sh" C-m
  echo "Launched jobs/job_20241007_sir_default_1_1.sh on tmux session sir_default_1_1"
