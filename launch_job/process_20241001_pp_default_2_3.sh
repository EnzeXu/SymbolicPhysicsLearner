...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t pp_default_2_3 "bash jobs/job_20241001_pp_default_2_3.sh" C-m
  echo "Launched jobs/job_20241001_pp_default_2_3.sh on tmux session pp_default_2_3"
