...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t pp_default_3 "source venv/bin/activate" C-m
  tmux send-keys -t pp_default_3 "bash jobs/job_20240401_pp_default_3_10.sh" C-m
  echo "Launched jobs/job_20240401_pp_default_3_10.sh"
