...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t sir_default_3 "source ../Invariant_Physics/venv/bin/activate" C-m
  tmux send-keys -t sir_default_3 "bash jobs/job_20240427_sir_default_3_11.sh" C-m
  echo "Launched jobs/job_20240427_sir_default_3_11.sh"
