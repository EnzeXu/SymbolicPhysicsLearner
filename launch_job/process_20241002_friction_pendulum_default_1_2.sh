...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t friction_pendulum_default_1_2 "bash jobs/job_20241002_friction_pendulum_default_1_2.sh" C-m
  echo "Launched jobs/job_20241002_friction_pendulum_default_1_2.sh on tmux session friction_pendulum_default_1_2"
