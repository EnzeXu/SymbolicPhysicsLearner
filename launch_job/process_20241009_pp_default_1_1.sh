...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t pp_default_1_1 "bash jobs/job_20241009_pp_default_1_1.sh" C-m
  echo "Launched jobs/job_20241009_pp_default_1_1.sh on tmux session pp_default_1_1"
