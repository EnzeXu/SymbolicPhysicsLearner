...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t lorenz_default_3 "source ../Invariant_Physics/venv/bin/activate" C-m
  tmux send-keys -t lorenz_default_3 "bash jobs/job_20240401_lorenz_default_3_10.sh" C-m
  echo "Launched jobs/job_20240401_lorenz_default_3_10.sh"
