...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t lorenz_default_1_4 "bash jobs/job_20241008_lorenz_default_1_4.sh" C-m
  echo "Launched jobs/job_20241008_lorenz_default_1_4.sh on tmux session lorenz_default_1_4"
