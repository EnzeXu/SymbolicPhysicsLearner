...
if [ $? != 0 ]; then
  ...
  tmux send-keys -t friction_pendulum_default_2_1 "bash jobs/job_20241006_friction_pendulum_default_2_1.sh" C-m
  echo "Launched jobs/job_20241006_friction_pendulum_default_2_1.sh on tmux session friction_pendulum_default_2_1"
